...
// Element Templates
import selections from './html/elements/selection.html';
import description from './html/elements/descripton.html';
import allowAllBtn from './html/elements/allow-all.html';
import allowBtn from './html/elements/allow.html';
import dismissBtn from './html/elements/dismiss.html';
import denyBtn from './html/elements/deny.html';
// Other Templates
import revokebutton from './html/revoke.html';
import iframeoverlay from './html/overlay.html';
// wrap
import windowWrap from './html/window.html';
// erxternals
